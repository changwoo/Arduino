...
// ATMEL ATMEGA644P/1284P on SANGUINO
//
//                   +---\/---+
...
#define analogInputToDigitalPin(p)  ((p < 16) ? (31 - (p)) : -1)
#define digitalPinHasPWM(p)         (((p) >= 3 && (p) <= 4) || ((p) >= 12 && (p)<= 15))
